...
const MOCK_USERS: MockUser[] = [
  {
    id: 900_001,
    userKey: sha('mock-user', 'zhangsan'),
    userName: '张三',
    wikiRootPath: '/Users/zhangsan/projects/bk-fe-knowledge-trade',
  },
  {
    id: 900_002,
    userKey: sha('mock-user', 'lisi'),
    userName: '李四',
    wikiRootPath: '/Users/lisi/projects/bk-fe-knowledge-trade',
  },
  {
    id: 900_003,
    userKey: sha('mock-user', 'wangwu'),
    userName: '王五',
    wikiRootPath: '/Users/wangwu/projects/bk-fe-knowledge-loan',
  },
  {
    id: 900_004,
    userKey: sha('mock-user', 'zhaoliu'),
    userName: '赵六',
    wikiRootPath: '/Users/zhaoliu/projects/bk-fe-knowledge-wealth',
  },
  {
    id: 900_005,
    userKey: sha('mock-user', 'sunqi'),
    userName: '孙七',
    wikiRootPath: '/Users/sunqi/projects/bk-fe-knowledge-trade',
  },
  {
    id: 900_006,
    userKey: sha('mock-user', 'zhouba'),
    userName: '周八',
    wikiRootPath: '/Users/zhouba/projects/bk-fe-knowledge-loan',
  },
  {
    id: 900_007,
    userKey: sha('mock-user', 'wujiu'),
    userName: '吴九',
    wikiRootPath: '/Users/wujiu/projects/bk-fe-knowledge-trade',
  },
  {
    id: 900_008,
    userKey: sha('mock-user', 'zhengshi'),
    userName: '郑十',
    wikiRootPath: '/Users/zhengshi/projects/bk-fe-knowledge-wealth',
  },
];
...
const MOCK_WORK_ITEMS: MockWorkItem[] = [
  {
    id: 900_001,
    workItemKey: sha('mock-wi', 'trade', '2026-04-10-unfreeze-component'),
    repo: 'trade',
    domain: 'cashier',
    slug: '2026-04-10-unfreeze-component',
  },
  {
    id: 900_002,
    workItemKey: sha('mock-wi', 'trade', '2026-03-22-batch-payout'),
    repo: 'trade',
    domain: 'cashier',
    slug: '2026-03-22-batch-payout',
  },
  {
    id: 900_003,
    workItemKey: sha('mock-wi', 'trade', '2026-03-05-refund-flow'),
    repo: 'trade',
    domain: 'cashier',
    slug: '2026-03-05-refund-flow',
  },
  {
    id: 900_004,
    workItemKey: sha('mock-wi', 'trade', '2026-02-20-settlement-t1'),
    repo: 'trade',
    domain: 'settlement',
    slug: '2026-02-20-settlement-t1',
  },
  {
    id: 900_005,
    workItemKey: sha('mock-wi', 'trade', '2026-04-01-market-data-cache'),
    repo: 'trade',
    domain: 'market-data',
    slug: '2026-04-01-market-data-cache',
  },
  {
    id: 900_006,
    workItemKey: sha('mock-wi', 'trade', '2026-03-15-recon-auto'),
    repo: 'trade',
    domain: 'reconciliation',
    slug: '2026-03-15-recon-auto',
  },
  {
    id: 900_007,
    workItemKey: sha('mock-wi', 'trade', '2026-04-20-algo-trading'),
    repo: 'trade',
    domain: 'trade-core',
    slug: '2026-04-20-algo-trading',
  },
  {
    id: 900_008,
    workItemKey: sha('mock-wi', 'trade', '2026-02-10-clearing-margin'),
    repo: 'trade',
    domain: 'clearing',
    slug: '2026-02-10-clearing-margin',
  },
  {
    id: 900_009,
    workItemKey: sha('mock-wi', 'loan', '2026-04-05-credit-ai'),
    repo: 'loan',
    domain: 'credit-review',
    slug: '2026-04-05-credit-ai',
  },
  {
    id: 900_010,
    workItemKey: sha('mock-wi', 'loan', '2026-03-18-risk-policy-v2'),
    repo: 'loan',
    domain: 'risk-control',
    slug: '2026-03-18-risk-policy-v2',
  },
  {
    id: 900_011,
    workItemKey: sha('mock-wi', 'loan', '2026-02-28-flexible-repay'),
    repo: 'loan',
    domain: 'loan-mgmt',
    slug: '2026-02-28-flexible-repay',
  },
  {
    id: 900_012,
    workItemKey: sha('mock-wi', 'loan', '2026-04-12-auto-collection'),
    repo: 'loan',
    domain: 'collection',
    slug: '2026-04-12-auto-collection',
  },
  {
    id: 900_013,
    workItemKey: sha('mock-wi', 'wealth', '2026-03-10-esg-portfolio'),
    repo: 'wealth',
    domain: 'portfolio',
    slug: '2026-03-10-esg-portfolio',
  },
  {
    id: 900_014,
    workItemKey: sha('mock-wi', 'wealth', '2026-04-15-robo-advisor'),
    repo: 'wealth',
    domain: 'advisor',
    slug: '2026-04-15-robo-advisor',
  },
  {
    id: 900_015,
    workItemKey: sha('mock-wi', 'wealth', '2026-02-25-index-fund'),
    repo: 'wealth',
    domain: 'fund-ops',
    slug: '2026-02-25-index-fund',
  },
];
...
function walk(
  ...
  for (const entry of fs.readdirSync(dir, { withFileTypes: true })) {
    ...
    if (entry.isDirectory()) {
      walk(full, repoRoot, repo, out, now, graceDays);
      continue;
    }
...
async function seed() {
  ...
  try {
    ...
    await conn.execute(
      `DELETE FROM sdd_users WHERE user_key LIKE '${sha('mock-user', '').slice(0, 10)}%'`,
    );
    ...
    const orphanPaths = [
      {
        repo: 'trade',
        path: 'domain-cashier/business/old-merchant-query.md',
        count: 12,
      },
      {
        repo: 'trade',
        path: 'domain-settlement/business/legacy-rtgs.md',
        count: 8,
      },
      {
        repo: 'loan',
        path: 'domain-credit-review/business/v1-scoring.md',
        count: 15,
      },
      {
        repo: 'wealth',
        path: 'domain-portfolio/business/deprecated-holdings.md',
        count: 6,
      },
      {
        repo: 'loan',
        path: 'domain-risk-control/business/old-fraud-v1.md',
        count: 4,
      },
    ];
    ...
    console.log(
      `   Recall 记录: ${totalReads} read + ${totalOther} glob/grep = ${totalReads + totalOther} + ${orphanPaths.reduce((s, o) => s + o.count, 0)} orphan`,
    );
    console.log('');
    console.log('启动命令：');
