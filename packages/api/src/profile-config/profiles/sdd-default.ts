...
const SDD_SEMANTICS: SddSemanticInput[] = [
  ...
  },
  {
    ...
    skillNames: ['bk-fe-codereview', 'bk-fe:codereview', 'bk-fe-code-review', 'bk-fe:code_review'],
  },
  {
  ...
  },
  {
    ...
    skillNames: ['bk-fe-test', 'bk-fe:test'],
  },
  {
    ...
    skillNames: ['bk-fe-risk-learn', 'bk-fe:risk-learn', 'bk-fe-risk_learn', 'bk-fe:risk_learn'],
  },
  {
    ...
    skillNames: ['bk-fe-legilimency', 'bk-fe:legilimency', 'bk-fe-legilimeny', 'bk-fe:legilimeny'],
  },
  {
  ...
  },
  {
    ...
    displayName: '诊断',
    artifactFilenamePatterns: [],
    skillNames: ['bk-fe-doctor', 'bk-fe:doctor'],
  },
  {
    semanticCode: 'help',
    displayName: '帮助',
    artifactFilenamePatterns: [],
    skillNames: ['bk-fe-help', 'bk-fe:help'],
  },
];
...
export const sddDefaultProfile: WorkflowProfileConfig = {
  ...
  sourceRules: [
    ...
    {
      locatorType: 'path',
      ruleId: 'sdd-requirements-process-doc',
      category: 'process_doc',
      priority: 85,
      confidence: 'high',
      enabled: true,
      userRootKey: 'requirements',
  ...
  deliveryUnitRules: [
    {
      ruleId: 'sdd-requirements-unit',
      sourceRuleIds: ['sdd-requirements-process-doc'],
  ...
  artifactRules: [
    {
      ruleId: 'sdd-artifact',
      sourceRuleIds: ['sdd-requirements-process-doc'],
      typePatterns: skillCfg.artifactTypePatterns,
  ...
  capabilityRules: [
    ...
    {
      ruleId: 'cap-other-skill',
      sourceRuleIds: ['skill-other'],
      actions: ['invoke'],
      capabilityCode: 'other-skill',
      displayName: '未纳入体系',
      surfaceRole: 'fallback',
    },
  ],
